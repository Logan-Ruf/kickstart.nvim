...
fun! s:register_default_theme()
  ...
  let s:themes['default'].dark = {
        ...
        \       'linenumber_bg' : ['#101010', '234'],
        \       'vertsplit_fg' : ['#5f8787', '66'],
        \       'vertsplit_bg' : ['#101010', '234'],
        \       'statusline_active_fg' : ['#101010', '234'],
...
let s:to_HEX = {
      ...
      \ '230': '#ffffd7',  '231': '#ffffff',  '232': '#080808',  '233': '#121212',  '234': '#101010',
